...
import de.nielstron.simplenextcloud.data.DocumentIds
...
class NextcloudDocumentsProvider : DocumentsProvider() {
    ...
    override fun createDocument(parentDocumentId: String, mimeType: String, displayName: String): String {
        ...
        val path = de.nielstron.simplenextcloud.data.NextcloudPath.child(parentPath, displayName)
        remote {
    ...
    override fun renameDocument(documentId: String, displayName: String): String {
        ...
        val newPath = de.nielstron.simplenextcloud.data.NextcloudPath.child(file.path.substringBeforeLast('/', ""), displayName)
        notifyChildren(DocumentIds.fromPath(file.path.substringBeforeLast('/', "")))
