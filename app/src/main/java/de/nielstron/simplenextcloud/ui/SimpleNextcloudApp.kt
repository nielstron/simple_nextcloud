...
import de.nielstron.simplenextcloud.FileUiState
import de.nielstron.simplenextcloud.FileViewModel
            ...
            Column(Modifier.fillMaxWidth(), horizontalAlignment = Alignment.CenterHorizontally) {
                ...
                AnimatedVisibility(waiting) {
                    Column(horizontalAlignment = Alignment.CenterHorizontally) {
                        Text(
                            "Waiting for browser approval. An expired or outdated request is normal " +
                                "after an interruption—tap Restart login to try again.",
                            style = MaterialTheme.typography.bodySmall,
                            color = MaterialTheme.colorScheme.onSurfaceVariant,
                        )
